...
add wave -noupdate {/MIPS_Processor_TB/DUV/RAM/ram[1023]}
add wave -noupdate {/MIPS_Processor_TB/DUV/RAM/ram[1022]}
add wave -noupdate {/MIPS_Processor_TB/DUV/RAM/ram[1021]}
add wave -noupdate {/MIPS_Processor_TB/DUV/RAM/ram[1020]}
...
WaveRestoreCursors {{Cursor 1} {359576200 ps} 0} {{Cursor 2} {886 ps} 0}
